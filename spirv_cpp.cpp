...
void CompilerCPP::emit_header()
{
	...
	case ExecutionModelGeometry:
		statement("#define SPIRV_CROSS_EXEC_GEOM");
		break;
	case ExecutionModelTessellationControl:
		statement("#define SPIRV_CROSS_EXEC_TESC");
		break;
	case ExecutionModelTessellationEvaluation:
		statement("#define SPIRV_CROSS_EXEC_TESE");
		break;
	case ExecutionModelGLCompute:
		statement("#define SPIRV_CROSS_EXEC_COMP");
		break;
	case ExecutionModelFragment:
		statement("#define SPIRV_CROSS_EXEC_FRAG");
		break;
	case ExecutionModelVertex:
		statement("#define SPIRV_CROSS_EXEC_VERT");
		break;
