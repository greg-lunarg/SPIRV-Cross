...
typedef enum spirv_cross_builtin {
	...
	SPIRV_CROSS_BUILTIN_INSTANCE_IDX = 5,
	SPIRV_CROSS_BUILTIN_DRAW_INDEX = 6,
	SPIRV_CROSS_BUILTIN_BASE_VERTEX = 7,
	SPIRV_CROSS_BUILTIN_BASE_INSTANCE = 8,
        SPIRV_CROSS_BUILTIN_SAMPLE_MASK_IN = 9,
        SPIRV_CROSS_BUILTIN_FRONT_FACING = 10,
        SPIRV_CROSS_BUILTIN_CLIP_DISTANCE = 11,
        SPIRV_CROSS_BUILTIN_CULL_DISTANCE = 12,
        SPIRV_CROSS_BUILTIN_POINT_COORD = 13,
        SPIRV_CROSS_BUILTIN_PRIMITIVE_ID = 14,
        SPIRV_CROSS_BUILTIN_SAMPLE_ID = 15,
        SPIRV_CROSS_BUILTIN_SAMPLE_POS = 16,
        SPIRV_CROSS_BUILTIN_SAMPLE_MASK = 17,
        SPIRV_CROSS_BUILTIN_LAYER = 18,
        SPIRV_CROSS_BUILTIN_VIEWPORT_IDX = 19,
        SPIRV_CROSS_BUILTIN_HELPER_INV = 20,
        SPIRV_CROSS_BUILTIN_FRAG_DEPTH = 21,
